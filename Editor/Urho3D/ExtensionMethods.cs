...
namespace UnityToCustomEngineExporter.Editor.Urho3D
{
    public static class ExtensionMethods
    {
        ...
        public static void WriteParameter(this XmlWriter writer, string name, Vector2 value)
        {
            ...
            writer.WriteStartElement("parameter");
            writer.WriteAttributeString("name", name);
            writer.WriteAttributeString("value", string.Format(CultureInfo.InvariantCulture, "{0} {1}", value.x, value.y));
            writer.WriteEndElement();
            writer.WriteWhitespace(Environment.NewLine);
        }
        ...
        public static void WriteParameter(this XmlWriter writer, string name, Vector4 value)
        {
            ...
            writer.WriteStartElement("parameter");
            writer.WriteAttributeString("name", name);
            writer.WriteAttributeString("value", string.Format(CultureInfo.InvariantCulture, "{0} {1} {2} {3}", value.x, value.y, value.z, value.w));
            writer.WriteEndElement();
            writer.WriteWhitespace(Environment.NewLine);
        }
        ...
        public static void WriteElementParameter(this XmlWriter writer, string parameterName, string valueName, string value)
        {
            writer.WriteWhitespace("\t");
