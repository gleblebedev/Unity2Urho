...
namespace UnityToCustomEngineExporter.Editor.Urho3D
{
    public class PrefabContext
    {
        ...
        public PrefabContext Retarget(GameObject gameObject)
        {
            ...
            if (root == null)
            {
                return new PrefabContext(_engine, null, _defaultFolder);
            }
            ...
            var relPathFromAssetPath = ExportUtils.GetRelPathFromAssetPath(_engine.Options.Subfolder,  ExportUtils.ReplaceExtension(assetPath,""));
